...
function validateNom(){
    var nomRegExp = new RegExp('^[a-zA-Z-\' æœçéàèùâêîôûëïüÿÂÊÎÔÛÄËÏÖÜÀÆÇÉÈŒÙ]{3,}$', 'g');
    var testNom = nomRegExp.test();
    if (testNom) {
...
app.post('/restaurant', (req, res) =>{
    ...
    str1 = req.body.city;
    str2 = req.body.city;
    nb = req.body.nbcouverts;
    req.body.name = validateNom(req.body.name);
    req.body.name = apostrophe(str);
    req.body.city = validateNom(req.body.city);
    req.body.city = apostrophe(str1);
    req.body.nbcouverts = nombre(nb);
...
app.post('/employe', (req, res) => {
    str = req.body.first_name;
    str1 = req.body.last_name;
    str2 = req.body.city;
    mydate = req.body.hire_date;
    req.body.first_name = validateNom(req.body.first_name);
    req.body.first_name = apostrophe(str);
    req.body.last_name = validateNom(req.body.last_name);
    req.body.last_name = apostrophe(str1);
    req.body.hire_date = newDate(mydate);
